...
public class PlayerSpawnerNew : MonoBehaviour
{
    #region Public.
    /// <summary>
    ...
    public List<Transform> takim_A = new List<Transform>();
    public List<Transform> takim_B = new List<Transform>();

    public static PlayerSpawnerNew singleton;
